...
function ThemedBoard({ teams, theme, anim, config, aliveStyle = "rounded", aliveLayout = "grid", aliveCustomAlive = null, aliveCustomDead = null }) {
  const boardWidth = (config?.board?.width || 320) + 14;
  const columns = config?.compactMode
