...
function EngineThemedRow({ team, index, theme, anim, columns, aliveStyle, aliveLayout = "grid", aliveCustomAlive = null, aliveCustomDead = null }) {
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 5, minWidth: 0 }}>
        ...
        >
          {team.logo ? (
            <img src={`${API}${team.logo}`} alt="" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
          ) : (
            <span style={{ color: theme.colors.gold, fontSize: 9, fontWeight: 800 }}>
...
export default memo(EngineThemedRow);
